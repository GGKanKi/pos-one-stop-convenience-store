      ...
      <main className="flex-1 p-6 flex flex-col gap-6 overflow-y-auto text-left">
        ...
        <div className="bg-white p-3 rounded-[2rem] shadow-sm flex items-center gap-4">
          ...
          <div className="flex gap-3 ml-auto">
            ...
            <button className="px-8 py-2 rounded-xl font-bold text-xs uppercase bg-yellow-500 text-white shadow-md hover:bg-yellow-600 hover:scale-105 active:scale-95">
              Inventory Check
            </button>
          </div>
        </div>
            ...
            <table className="w-full text-left">
              <thead className="bg-[#0056b3] text-white font-bold uppercase text-[13px]">
                <tr>
                  ...
                  <th className="p-6 text-center leading-tight">Stock Threshold</th>
              ...
              <tbody className="divide-y-2 divide-gray-50 font-bold text-gray-700">
                {products.map((item, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-6 text-center">{item.stock}</td>
                    <td className="p-6">
